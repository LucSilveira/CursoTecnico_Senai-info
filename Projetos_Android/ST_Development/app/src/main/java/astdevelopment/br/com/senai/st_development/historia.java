...
public class historia extends AppCompatActivity
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                    ...
                    Intent intent  = new Intent(historia.this, SendMensagem.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_atua) {
            Intent intent  = new Intent(historia.this, areas.class);
            startActivity(intent);
        } else if (id == R.id.nav_historia) {
            Intent intent  = new Intent(historia.this, historia.class);
            startActivity(intent);
        } else if (id == R.id.nav_contato) {
            Intent intent  = new Intent(historia.this, SendMensagem.class);
            startActivity(intent);
        } else if (id == R.id.nav_lista) {
            Intent intent  = new Intent(historia.this, lista.class);
            startActivity(intent);
